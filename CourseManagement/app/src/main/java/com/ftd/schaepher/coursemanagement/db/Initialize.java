...
public class Initialize {
    ...
    public void init(Context context) {
        ...
        tableUserTeachingOffice.setWorkNumber("00001");
        tableUserTeachingOffice.setPassword("00001");
        tableUserTeachingOffice.setName("张晴");
        ...
        tableUserTeacher.setWorkNumber("00001");
        tableUserTeacher.setPassword("00001");
        tableUserTeacher.setName("陈西瓜");
